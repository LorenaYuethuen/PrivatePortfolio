      ...
      <section className="max-w-[1440px] mx-auto px-[120px] py-20">
        ...
        <div className="max-w-4xl mx-auto space-y-6">
          {experience.map((job, index) => (
            <div 
              key={index}
              className="bg-[var(--card-dark)] border border-[var(--border-light)] rounded-2xl p-8 hover:border-[var(--theme-primary)] transition-colors"
            >
              <div className="flex items-start justify-between mb-4">
                <div>
                  <h3 className="text-[var(--text-primary)] mb-2">{job.title}</h3>
                  <p className="text-[var(--theme-secondary)]">{job.company}</p>
                </div>
        ...
        <div className="bg-gradient-to-br from-[var(--card-dark)] to-[var(--bg-secondary)] border border-[var(--border-light)] rounded-3xl p-16 text-center">
          ...
          <div className="flex items-center justify-center gap-4">
            <a 
              ...
              className="w-14 h-14 rounded-xl bg-[var(--bg-primary)] border border-[var(--border-light)] flex items-center justify-center hover:border-[var(--theme-primary)] hover:shadow-[0_0_24px_var(--theme-primary)] transition-all"
            >
              <Linkedin className="w-6 h-6 text-[var(--theme-primary)]" />
            </a>
            <a 
              ...
              className="w-14 h-14 rounded-xl bg-[var(--bg-primary)] border border-[var(--border-light)] flex items-center justify-center hover:border-[var(--theme-primary)] hover:shadow-[0_0_24px_var(--theme-primary)] transition-all"
            >
              <Github className="w-6 h-6 text-[var(--theme-primary)]" />
            </a>
            <a 
              href="mailto:hello@portfolio.com"
              className="w-14 h-14 rounded-xl bg-[var(--bg-primary)] border border-[var(--border-light)] flex items-center justify-center hover:border-[var(--theme-primary)] hover:shadow-[0_0_24px_var(--theme-primary)] transition-all"
