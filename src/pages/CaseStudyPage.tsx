  ...
  return (
    <div className="min-h-screen pt-24">
      ...
      <div className="max-w-[1440px] mx-auto px-[120px] py-6">
        <Link 
          to="/projects"
          className="inline-flex items-center gap-2 text-[var(--text-secondary)] hover:text-[var(--theme-primary)] transition-colors"
        >
        ...
        <div className="flex items-center gap-20">
          ...
          <div className="flex-1 flex flex-col gap-6">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[var(--card-dark)] border border-[var(--border-light)] w-fit">
              <span className="text-sm text-[var(--theme-primary)]">Featured Project</span>
            </div>
      ...
      {/* Problem & Goals */}
      <section className="max-w-[1440px] mx-auto px-[120px] py-20 border-b border-[var(--theme-primary)]/20">
          ...
          <div className="flex-1">
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                <div className="w-6 h-6 rounded-full bg-[var(--theme-primary)]/20 flex items-center justify-center flex-shrink-0 mt-1">
      ...
      <section className="max-w-[1440px] mx-auto px-[120px] py-20">
        ...
        <div className="grid grid-cols-4 gap-6">
          {insights.map((insight, index) => (
            <div 
              key={index}
              className="bg-[var(--card-dark)] border border-[var(--border-light)] rounded-xl p-6 hover:border-[var(--theme-primary)] transition-colors"
            >
          ...
          {userFlow.map((step, index) => (
            <div key={index} className="flex items-center">
              <div className="flex flex-col items-center gap-4">
                <div className="w-16 h-16 rounded-full bg-[var(--theme-primary)] flex items-center justify-center glow-neon-blue" style={{ color: 'var(--bg-primary)' }}>
                  <span>{index + 1}</span>
                </div>
              ...
              {index < userFlow.length - 1 && (
                <div className="w-24 h-[2px] bg-[var(--theme-primary)]/30 mx-4 glow-neon-blue" />
              )}
            </div>
          ))}
        </div>
      ...
      <section className="max-w-[1440px] mx-auto px-[120px] py-20 mb-20">
        <div className="bg-[var(--card-dark)] border border-[var(--border-light)] rounded-3xl p-16 card-shadow">
          ...
          <div className="grid grid-cols-3 gap-8 mb-12 pb-12 border-b border-[var(--border-light)]">
            <div>
              <div className="text-5xl mb-2 bg-gradient-to-r from-[var(--theme-primary)] to-[var(--theme-secondary)] bg-clip-text text-transparent">
                85%
              </div>
