  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative h-[900px] flex items-center justify-center gradient-radial noise-overlay overflow-hidden">
        {/* Decorative elements */}
        <div className="absolute top-20 right-20 w-96 h-96 bg-[var(--theme-primary)] opacity-10 blur-[100px] rounded-full" />
        <div className="absolute bottom-20 left-20 w-96 h-96 bg-[var(--theme-secondary)] opacity-10 blur-[100px] rounded-full" />
        ...
        <div className="relative z-10 flex flex-col items-center text-center gap-8 px-12 max-w-6xl">
          ...
          <div className="flex items-center gap-6 mt-4">
            <Link 
              to="/projects"
              className="group flex items-center gap-2 px-8 py-4 rounded-xl bg-[var(--theme-primary)] hover:shadow-[0_0_48px_var(--theme-primary)] transition-all"
            ...
            <a 
              href="#contact"
              className="px-8 py-4 rounded-xl bg-[var(--bg-secondary)] border border-[var(--border-light)] text-[var(--text-primary)] hover:border-[var(--theme-primary)] hover:shadow-[0_0_24px_var(--theme-primary)] transition-all"
            >
              Get in Touch
            </a>
          </div>
              ...
              <div className="flex flex-col gap-8">
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 rounded-xl bg-[var(--theme-primary)]/10 flex items-center justify-center">
                    <Award className="w-6 h-6 text-[var(--theme-primary)]" />
                  </div>
                  <div>
                ...
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 rounded-xl bg-[var(--theme-secondary)]/10 flex items-center justify-center">
                    <Users className="w-6 h-6 text-[var(--theme-secondary)]" />
                  </div>
                  <div>
                ...
                <div className="grid grid-cols-3 gap-6 pt-6 border-t border-[var(--border-light)]">
                  <div>
                    <div className="text-4xl mb-1 bg-gradient-to-r from-[var(--theme-primary)] to-[var(--theme-secondary)] bg-clip-text text-transparent">50+</div>
                    <div className="text-sm text-[var(--text-secondary)]">Projects</div>
                  </div>
                  <div>
                    <div className="text-4xl mb-1 bg-gradient-to-r from-[var(--theme-primary)] to-[var(--theme-secondary)] bg-clip-text text-transparent">30+</div>
                    <div className="text-sm text-[var(--text-secondary)]">Clients</div>
                  </div>
                  <div>
                    <div className="text-4xl mb-1 bg-gradient-to-r from-[var(--theme-primary)] to-[var(--theme-secondary)] bg-clip-text text-transparent">5</div>
      ...
      <section className="max-w-[1440px] mx-auto px-[120px] pb-[120px]">
        <div className="flex flex-col gap-12">
          ...
          <div className="text-center">
            <Link 
              to="/projects"
              className="inline-flex items-center gap-2 px-8 py-4 rounded-xl border border-[var(--border-light)] text-[var(--text-primary)] hover:border-[var(--theme-primary)] hover:shadow-[0_0_24px_var(--theme-primary)] transition-all"
            >
              View All Projects
      ...
      <section className="max-w-[1440px] mx-auto px-[120px] pb-[120px]">
        <div className="relative bg-gradient-to-br from-[var(--card-dark)] to-[var(--bg-secondary)] border border-[var(--border-light)] rounded-3xl p-16 text-center overflow-hidden">
          <div className="absolute top-0 right-0 w-64 h-64 bg-[var(--theme-primary)] opacity-5 blur-[80px] rounded-full" />
          <div className="absolute bottom-0 left-0 w-64 h-64 bg-[var(--theme-secondary)] opacity-5 blur-[80px] rounded-full" />
          ...
          <div className="relative z-10">
            ...
            <a 
              ...
              className="inline-flex items-center gap-2 px-8 py-4 rounded-xl bg-[var(--theme-primary)] hover:shadow-[0_0_48px_var(--theme-primary)] transition-all"
              style={{ color: 'var(--bg-primary)' }}
            >
