...
export function ProjectCard({ id, title, description, tags, image, height = '260px' }: ProjectCardProps) {
  return (
    ...
    >
      <div 
        className="bg-[var(--card-dark)] border border-[var(--border-light)] rounded-2xl p-4 transition-all hover:border-[var(--theme-primary)] hover:shadow-[0_0_32px_var(--theme-primary)] card-shadow"
        style={{ height }}
      >
        <div className="flex flex-col h-full gap-4">
          ...
          <div className="flex flex-col gap-2">
            <h3 className="text-[var(--text-primary)] group-hover:text-[var(--theme-primary)] transition-colors">
              {title}
            </h3>
